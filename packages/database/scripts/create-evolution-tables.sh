#!/bin/bash
# Create evolution engine tables directly in PostgreSQL
...
echo "🚀 Creating evolution engine tables..."
...
-- evolution_proposals: Candidate improvements per day
...
-- sanity_checks: Results of gates per proposal
...
-- experiments: Rollouts and outcomes
...
-- feature_flags: Runtime safety controls
...
echo "✅ Evolution tables migration completed successfully!"
