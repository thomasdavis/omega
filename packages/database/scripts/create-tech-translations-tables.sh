...
# Usage: railway run bash -c 'export DATABASE_URL=$DATABASE_PUBLIC_URL && bash packages/database/scripts/create-tech-translations-tables.sh'
...
-- CreateIndexes for tech_translations
CREATE INDEX IF NOT EXISTS "idx_tech_translations_user_id" ON "tech_translations"("user_id");
CREATE INDEX IF NOT EXISTS "idx_tech_translations_created_at" ON "tech_translations"("created_at" DESC);
...
-- CreateIndexes for tech_translation_feedback
CREATE INDEX IF NOT EXISTS "idx_tech_translation_feedback_translation_id" ON "tech_translation_feedback"("translation_id");
CREATE INDEX IF NOT EXISTS "idx_tech_translation_feedback_user_id" ON "tech_translation_feedback"("user_id");

-- Verify
SELECT table_name FROM information_schema.tables
WHERE table_schema = 'public'
AND table_name IN ('tech_translations', 'tech_translation_feedback')
ORDER BY table_name;
...
AND tablename IN ('tech_translations', 'tech_translation_feedback')
