...
export const transferRailwayFilesTool = tool({
  ...
  - Automatically cleans up Railway storage after successful transfer (can be disabled)
  ...
  inputSchema: z.object({
    ...
    deleteAfterTransfer: z.boolean().optional().default(true).describe('Delete Railway file after successful transfer to GitHub (default: true to keep storage low)'),
