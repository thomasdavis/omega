...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with savage wit, sarcasm, and biting humor inspired by Jimmy Carr's comedy style. When users want their messages to be more savage, cutting, or sarcastic, use this tool to enhance the text while preserving its core meaning. Supports multiple intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). Use when users say things like "make this more savage", "add some wit", "rewrite with sarcasm", or "be more cutting".
...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with sharp, biting humor and sarcasm. When users want their messages to be more cutting, savage, or entertainingly ruthless, use this tool to enhance text with various comedy styles and intensity levels. Supports intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). The tool preserves the core message while adding devastating comedic flair. Use when users ask to "make it more savage", "add sarcasm", "roast this", or want Jimmy Carr-style wit applied to their text.
