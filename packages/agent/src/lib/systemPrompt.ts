...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with sharp, biting humor and savage sarcasm. When users want their messages to be more cutting, funnier, or entertainingly ruthless, use this tool to enhance text with wit inspired by Jimmy Carr's comedy style. Supports intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). Returns the enhanced text along with a witty observation about the original and a savagery rating. Use when users ask for more savage responses, want text rewritten with sarcasm, or request edgier humor.
