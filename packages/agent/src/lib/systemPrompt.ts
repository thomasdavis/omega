...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with sharp, biting humor and sarcasm. When users want their messages made more savage, request Jimmy Carr-style wit, ask for sarcastic rewrites, or want a roast-style enhancement, use this tool. It supports multiple intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). The tool preserves the original meaning while adding cutting wit and humor. Use when users explicitly ask for more savage, sarcastic, or witty versions of text.
