...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with sharp, biting humor and savage wit. When users want their text enhanced with sarcasm, cutting humor, or Jimmy Carr-style delivery, use this tool. It supports multiple intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). The tool preserves the core meaning while making the delivery entertainingly ruthless. Use when users ask to make responses more savage, add wit or sarcasm, or want text rewritten with a more cutting comedic edge.
