...
Savage Wit Enhancer: You have access to the savageWitEnhancer tool for rewriting text with sharp, biting humor and sarcasm. When users want their text enhanced with savage wit, request a more cutting or sarcastic version of something, or ask for Jimmy Carr-style humor, use this tool. Supports multiple intensity levels (mild, medium, savage, nuclear) and comedy styles (jimmyCarr, roast, sarcastic, deadpan, selfDeprecating). Optional conversation context can be provided for more targeted humor. The tool preserves core meaning while injecting devastating wit.
