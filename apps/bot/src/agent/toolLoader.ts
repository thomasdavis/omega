...
const TOOL_IMPORT_MAP: Record<string, { path: string; exportName: string }> = {
  ...
  mongoFind: { path: '../mongodb/tools/mongoFind.js', exportName: 'mongoFindTool' },
  mongoFindOne: { path: '../mongodb/tools/mongoFindOne.js', exportName: 'mongoFindOneTool' },
  mongoUpdate: { path: '../mongodb/tools/mongoUpdate.js', exportName: 'mongoUpdateTool' },
  mongoDelete: { path: '../mongodb/tools/mongoDelete.js', exportName: 'mongoDeleteTool' },
  mongoCount: { path: '../mongodb/tools/mongoCount.js', exportName: 'mongoCountTool' },
  mongoListCollections: { path: '../mongodb/tools/mongoListCollections.js', exportName: 'mongoListCollectionsTool' },
  mongoCreateCollection: { path: '../mongodb/tools/mongoCreateCollection.js', exportName: 'mongoCreateCollectionTool' },
  mongoDropCollection: { path: '../mongodb/tools/mongoDropCollection.js', exportName: 'mongoDropCollectionTool' },
  mongoRenameCollection: { path: '../mongodb/tools/mongoRenameCollection.js', exportName: 'mongoRenameCollectionTool' },
  mongoAggregate: { path: '../mongodb/tools/mongoAggregate.js', exportName: 'mongoAggregateTool' },
  mongoCreateIndex: { path: '../mongodb/tools/mongoCreateIndex.js', exportName: 'mongoCreateIndexTool' },
  mongoListIndexes: { path: '../mongodb/tools/mongoListIndexes.js', exportName: 'mongoListIndexesTool' },
  mongoDropIndex: { path: '../mongodb/tools/mongoDropIndex.js', exportName: 'mongoDropIndexTool' },

  // PostgreSQL tools (13)
  pgQuery: { path: '../postgres/tools/pgQuery.js', exportName: 'pgQueryTool' },
  pgInsert: { path: '../postgres/tools/pgInsert.js', exportName: 'pgInsertTool' },
  pgSelect: { path: '../postgres/tools/pgSelect.js', exportName: 'pgSelectTool' },
  pgUpdate: { path: '../postgres/tools/pgUpdate.js', exportName: 'pgUpdateTool' },
  pgDelete: { path: '../postgres/tools/pgDelete.js', exportName: 'pgDeleteTool' },
  pgCount: { path: '../postgres/tools/pgCount.js', exportName: 'pgCountTool' },
  pgListTables: { path: '../postgres/tools/pgListTables.js', exportName: 'pgListTablesTool' },
  pgCreateTable: { path: '../postgres/tools/pgCreateTable.js', exportName: 'pgCreateTableTool' },
  pgDropTable: { path: '../postgres/tools/pgDropTable.js', exportName: 'pgDropTableTool' },
  pgDescribeTable: { path: '../postgres/tools/pgDescribeTable.js', exportName: 'pgDescribeTableTool' },
  pgCreateIndex: { path: '../postgres/tools/pgCreateIndex.js', exportName: 'pgCreateIndexTool' },
  pgListIndexes: { path: '../postgres/tools/pgListIndexes.js', exportName: 'pgListIndexesTool' },
  pgDropIndex: { path: '../postgres/tools/pgDropIndex.js', exportName: 'pgDropIndexTool' },
