...
const TOOL_IMPORT_MAP: Record<string, { path: string; exportName: string }> = {
  ...
  // MongoDB tools (14)
  mongoInsert: { path: '../../../../packages/database/dist/mongodb/tools/mongoInsert.js', exportName: 'mongoInsertTool' },
  mongoFind: { path: '../../../../packages/database/dist/mongodb/tools/mongoFind.js', exportName: 'mongoFindTool' },
  mongoFindOne: { path: '../../../../packages/database/dist/mongodb/tools/mongoFindOne.js', exportName: 'mongoFindOneTool' },
  mongoUpdate: { path: '../../../../packages/database/dist/mongodb/tools/mongoUpdate.js', exportName: 'mongoUpdateTool' },
  mongoDelete: { path: '../../../../packages/database/dist/mongodb/tools/mongoDelete.js', exportName: 'mongoDeleteTool' },
  mongoCount: { path: '../../../../packages/database/dist/mongodb/tools/mongoCount.js', exportName: 'mongoCountTool' },
  mongoListCollections: { path: '../../../../packages/database/dist/mongodb/tools/mongoListCollections.js', exportName: 'mongoListCollectionsTool' },
  mongoCreateCollection: { path: '../../../../packages/database/dist/mongodb/tools/mongoCreateCollection.js', exportName: 'mongoCreateCollectionTool' },
  mongoDropCollection: { path: '../../../../packages/database/dist/mongodb/tools/mongoDropCollection.js', exportName: 'mongoDropCollectionTool' },
  mongoRenameCollection: { path: '../../../../packages/database/dist/mongodb/tools/mongoRenameCollection.js', exportName: 'mongoRenameCollectionTool' },
  mongoAggregate: { path: '../../../../packages/database/dist/mongodb/tools/mongoAggregate.js', exportName: 'mongoAggregateTool' },
  mongoCreateIndex: { path: '../../../../packages/database/dist/mongodb/tools/mongoCreateIndex.js', exportName: 'mongoCreateIndexTool' },
  ...
  pgUpdate: { path: '../../../../packages/database/dist/postgres/tools/pgUpdate.js', exportName: 'pgUpdateTool' },
  pgDelete: { path: '../../../../packages/database/dist/postgres/tools/pgDelete.js', exportName: 'pgDeleteTool' },
  pgCount: { path: '../../../../packages/database/dist/postgres/tools/pgCount.js', exportName: 'pgCountTool' },
  pgListTables: { path: '../../../../packages/database/dist/postgres/tools/pgListTables.js', exportName: 'pgListTablesTool' },
  ...
  summarizeUserProfiles: { path: './tools/summarizeUserProfiles.js', exportName: 'summarizeUserProfilesTool' },
