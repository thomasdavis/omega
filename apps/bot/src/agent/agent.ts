...
import { toolListTool } from './tools/toolList.js';
...
DO NOT ask the user to re-upload. DO NOT explain attachment issues. Just call the tool.`;
    ...
    // Define all tools and register them in the central registry
    const tools = {
      search: searchTool,
      ...
      toolList: toolListTool,
    };

    // Register all tools in the central registry for introspection
